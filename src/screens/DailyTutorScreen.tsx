...
const styles = StyleSheet.create({
  ...
  screenTitle: { fontSize: 24, fontWeight: '800', color: '#111827', letterSpacing: -0.5, marginBottom: 12 },
  card: {
    backgroundColor: '#fff',
    borderRadius: 16,
    padding: 16,
  ...
  progressLine: { fontSize: 14, fontWeight: '600', color: '#059669', marginTop: 8 },
  ...
  activityRowCurrent: { backgroundColor: '#ECFDF5', paddingHorizontal: 8 },
  activityIndex: { fontSize: 14, color: '#9CA3AF', marginRight: 8, marginTop: 2 },
  activityBody: { flex: 1 },
  activityTitle: { fontSize: 15, fontWeight: '600', color: '#111827' },
  activityKind: { fontSize: 12, color: '#9CA3AF', marginTop: 1 },
  activityReason: { fontSize: 13, color: '#6B7280', marginTop: 2 },
  activityDone: { fontSize: 12, color: '#059669', marginTop: 4, fontWeight: '600' },
  activitySkipped: { fontSize: 12, color: '#9CA3AF', marginTop: 4 },
  activityStatusPill: {
    backgroundColor: '#F3F4F6',
    borderRadius: 999,
    paddingHorizontal: 8,
  ...
  activityStatusText: { fontSize: 12, color: '#374151', fontWeight: '600' },
  primaryButton: {
