...
const styles = StyleSheet.create({
  ...
  headline: { fontSize: 16, color: '#111827', marginBottom: 4, fontWeight: '600' },
  body: { fontSize: 14, color: '#374151', marginBottom: 8, lineHeight: 22 },
  muted: { fontSize: 13, color: '#6B7280', marginBottom: 8 },
  section: { marginTop: 12 },
  sectionTitle: { fontSize: 12, fontWeight: '700', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: 0.5, marginBottom: 6, marginTop: 8 },
  listLine: { fontSize: 14, color: '#374151', marginBottom: 4 },
  notice: { fontSize: 12, color: '#D97706', marginBottom: 4 },
  savedLine: { fontSize: 13, color: '#059669', fontWeight: '600', marginTop: 8 },
  ...
  micButtonOn: { backgroundColor: '#DC2626' },
  ...
  targetText: { fontSize: 15, color: '#111827', fontWeight: '600' },
  optionButton: {
    borderWidth: 1,
    borderColor: '#D1D5DB',
    borderRadius: 12,
